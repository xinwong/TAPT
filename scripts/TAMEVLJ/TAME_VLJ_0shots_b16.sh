...
WEIGHTSPATH='/path/to/MMoP/output/train/imagenet/MoEAdvMaPLe/vit_b16_c2_ep100_batch32_2ctx_9depth_cross_datasets_16shots'
    ...
    for DATASET in "${DATASETS[@]}"; do
        for LOADEP in "${EPOCHS[@]}"; do
            ...
            if [ -d "$DIR" ]; then
                ...
                TAPT.VIS_MEANS ./stats/TAME/vitb16/TAME_VLJ_means_vitb16_train_adv.pt \
                TAPT.VIS_VARS ./stats/TAME/vitb16/TAME_VLJ_vars_vitb16_train_adv.pt \
                TAPT.VIS_MEANS_CLEAN ./stats/TAME/vitb16/TAME_VLJ_means_vitb16_train_clean.pt \
                TAPT.VIS_VARS_CLEAN ./stats/TAME/vitb16/TAME_VLJ_vars_vitb16_train_clean.pt
            fi
