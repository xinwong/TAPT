...
WEIGHTSPATH='/mnt/shared-storage-user/wangxin2/PromptLearning/Multimodal-Adversarial-Prompt-Tuning/output2025/train/imagenet/MoEAdvIVLP/vit_b32_c2_ep100_batch32_2+2ctx_9depth_16shots'
...
for ATTACK in "${ATTACKS[@]}"; do
    ...
    ADV_DIR=/mnt/shared-storage-user/evoagi-share/xinwang/TAPT/output2025/evaluation/${ATTACK}/MoEAdvIVLP
