...
resolve_model_settings() {
    ...
    case "${model_variant}" in
        vit_b16)
            ...
            WEIGHTSPATH_ADV='/mnt/shared-storage-user/wangxin2/PromptLearning/Multimodal-Adversarial-Prompt-Tuning/output2025/train/imagenet/MoEAdvVPT/vit_b16_c2_ep100_batch32_2ctx_9depth_16shots'
            WEIGHTSPATH_CLEAN='/mnt/shared-storage-user/wangxin2/PromptLearning/Multimodal-Adversarial-Prompt-Tuning/output2025/train/imagenet/MoEAdvVPT/vit_b16_c2_ep100_batch32_2ctx_9depth_clean_16shots'
            ;;
        vit_b32)
            MODEL_SLUG=vitb32
            CFG=TAPT_vit_b32_c2_ep100_batch32_2ctx_9depth_cal
            WEIGHTSPATH_ADV='/mnt/shared-storage-user/wangxin2/PromptLearning/Multimodal-Adversarial-Prompt-Tuning/output2025/train/imagenet/MoEAdvVPT/vit_b32_c2_ep100_batch32_2ctx_9depth_16shots'
            WEIGHTSPATH_CLEAN='/mnt/shared-storage-user/wangxin2/PromptLearning/Multimodal-Adversarial-Prompt-Tuning/output2025/train/imagenet/MoEAdvVPT/vit_b32_c2_ep100_batch32_2ctx_9depth_clean_16shots'
            ;;
        *)
