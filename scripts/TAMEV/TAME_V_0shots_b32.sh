...
WEIGHTSPATH='/path/to/PromptLearning/Multimodal-Adversarial-Prompt-Tuning/output2025/train/imagenet/MoEAdvVPT/vit_b32_c2_ep100_batch32_2ctx_9depth_16shots'
...
for ATTACK in "${ATTACKS[@]}"; do
    ...
    ADV_DIR=/path/to/TAPT/output2025/evaluation/${ATTACK}/MoEAdvVPT
    ...
    for DATASET in "${DATASETS[@]}"; do
        for LOADEP in "${EPOCHS[@]}"; do
            ...
            if [ -d "$DIR" ]; then
                ...
                TAPT.VIS_MEANS ./stats/TAME/vitb32/TAME_V_means_vitb32_train_adv.pt \
                TAPT.VIS_VARS ./stats/TAME/vitb32/TAME_V_vars_vitb32_train_adv.pt \
                TAPT.VIS_MEANS_CLEAN ./stats/TAME/vitb32/TAME_V_means_vitb32_train_clean.pt \
                TAPT.VIS_VARS_CLEAN ./stats/TAME/vitb32/TAME_V_vars_vitb32_train_clean.pt
            fi
