...
WEIGHTSPATH='/path/to/PromptLearning/Multimodal-Adversarial-Prompt-Tuning/output2025/train/imagenet/AdvMaPLe/vit_b32_c2_ep100_batch32_2ctx_9depth_cross_datasets_16shots'
...
for ATTACK in "${ATTACKS[@]}"; do
    ...
    ADV_DIR=/path/to/TAPT/output2025/evaluation/${ATTACK}/AdvMaPLe
