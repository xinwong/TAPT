...
WEIGHTSPATH='/path/to/MMoP/output/train/imagenet/AdvMaPLe/vit_b32_c2_ep100_batch32_2ctx_9depth_cross_datasets_16shots'
...
for ATTACK in "${ATTACKS[@]}"; do
    ...
    ADV_DIR=/path/to/MMoP/output/evaluation/${ATTACK}/AdvMaPLe
