...
WEIGHTSPATH='/path/to/MMoP/output/train/imagenet/AdvVPT/vit_b16_c2_ep100_batch32_2ctx_9depth_16shots'
...
for ATTACK in "${ATTACKS[@]}"; do
    ...
    ADV_DIR=/path/to/MMoP/output/evaluation/${ATTACK}/AdvVPT
