...
WEIGHTSPATH='/mnt/shared-storage-user/wangxin2/PromptLearning/Multimodal-Adversarial-Prompt-Tuning/output2025/train/imagenet/AdvVPT/vit_b32_c2_ep100_batch32_2ctx_9depth_16shots'
    ...
    for DATASET in "${DATASETS[@]}"; do
        for LOADEP in "${EPOCHS[@]}"; do
            ...
            if [ -d "$DIR" ]; then
                ...
                TAPT.VIS_MEANS ./stats/vitb32/V_means_vitb32_train_adv.pt \
                TAPT.VIS_VARS ./stats/vitb32/V_vars_vitb32_train_adv.pt \
                TAPT.VIS_MEANS_CLEAN ./stats/vitb32/V_means_vitb32_train_clean.pt \
                TAPT.VIS_VARS_CLEAN ./stats/vitb32/V_vars_vitb32_train_clean.pt
